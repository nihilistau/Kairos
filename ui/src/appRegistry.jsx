 ...
 *
 * icon: a glyph name in kit/icons.jsx (G-ROOM-TOKENS checks it exists).
 *
...
import House from './apps/House.jsx'
...
export const APPS = [
  ...
  { id: 'chat', title: 'Chat', icon: 'chat', w: 560, h: 560, Component: Chat, css: 'chat', dock: false,
  ...
  { id: 'roomview', title: 'The view', icon: 'roomview', w: 520, h: 420, Component: RoomView, css: 'rv',
  ...
  { id: 'voice', title: 'Voice', icon: 'voice', w: 560, h: 460, Component: Voice, css: 'vc',
    TitleChip: VoiceChip,
    blurb: 'her voice — on/off, provider, who speaks. live, and a button to hear it' },
  { id: 'search', title: 'Search', icon: 'search', w: 640, h: 560, Component: Search, css: 'sr',
    TitleChip: SearchChip,
    blurb: 'web searches, hers and yours — and a box to run your own' },
  { id: 'wardrobe', title: 'Wardrobe', icon: 'wardrobe', w: 620, h: 560, Component: Wardrobe, css: 'wr',
    TitleChip: WardrobeChip,
    blurb: 'what she is wearing, what else she could be, and the moments she can show you' },
  { id: 'senses', title: 'Senses',  icon: 'senses', w: 560, h: 520, Component: Senses, css: 'sns',
    TitleChip: SensesChip,
    blurb: 'what she can see and hear, and what the room has looked like' },
  { id: 'tools',  title: 'Tools',   icon: 'tools', w: 720, h: 520, Component: Tools, css: 'tl',
    blurb: 'every tool she has, by family and by risk' },
  { id: 'board',  title: 'Board',   icon: 'board', w: 560, h: 440, Component: Board, css: 'bd',
    blurb: 'notes, reminders, things either of you wants kept in view' },
  { id: 'body',   title: 'Body',    icon: 'body', w: 640, h: 600, Component: BodyPanel, css: 'tel',
    blurb: 'his heart and his movement, live — and the exact sentence she is handed about them' },
  { id: 'house',  title: 'House',   icon: 'house', w: 620, h: 460, Component: House, css: 'ha',
    blurb: 'is Home Assistant reachable, and what of it reaches her' },
  { id: 'memory', title: 'Memory',  icon: 'memory', w: 700, h: 560, Component: Memory, css: 'mem',
    blurb: 'what she knows — live rows and retired ones, and re-filing them' },
  { id: 'decisions', title: 'Decisions', icon: 'decisions', w: 620, h: 540, Component: Decisions, css: 'dec',
    blurb: 'what is waiting on you' },
  { id: 'music',  title: 'Music',   icon: 'music', w: 560, h: 520, Component: Music, css: 'mus',
    dock: false, TitleChip: MusicChip,
    blurb: 'the record player — hers to reach for too' },
  { id: 'agency', title: 'Her own time', icon: 'agency', w: 620, h: 560, Component: Agency, css: 'ag',
    blurb: 'everything she did while you were away — hers, and not editable' },
  { id: 'research', title: 'Research', icon: 'research', w: 640, h: 560, Component: Research, css: 'rsc',
    TitleChip: ResearchChip,
    blurb: 'the paid tier, hers and yours — titles expand to the returned text' },
  { id: 'journal',title: 'Journal', icon: 'journal', w: 600, h: 500, Component: Journal, css: 'jr',
    blurb: 'what she writes at the end of a day — hers, you can only read it' },
  { id: 'story',  title: 'Story',   icon: 'story', w: 720, h: 580, Component: Story, css: 'sty',
    blurb: 'her prefix line by line, the chapters and their folds, the lanes — and the backup receipt' },
  { id: 'files',  title: 'Files',   icon: 'files', w: 620, h: 500, Component: Files, css: 'fl',
  ...
  { id: 'stage',  title: 'Stage',   icon: 'stage', w: 620, h: 560, Component: Stage, css: 'stg',
    TitleChip: StageChip,
    blurb: 'the scene, the rung it is on, and a stop that is always one click' },
  { id: 'games',  title: 'Games',   icon: 'games', w: 560, h: 640, Component: Games, css: 'gm',
    dock: false, TitleChip: GamesChip,
    blurb: 'a board you both touch — the rules belong to the engine, not the page' },
  { id: 'ledger', title: 'Ledger',  icon: 'ledger', w: 760, h: 620, Component: Ledger, css: 'lgr',
    blurb: 'the plan, what we parked, and everything noticed and not touched' },
  { id: 'room',   title: 'The room',icon: 'room', w: 560, h: 460, Component: Room, css: 'rm',
    TitleChip: RoomChip,
    blurb: 'her hourly notes on the room — the eye waits for quiet before it looks' },
  { id: 'presence', title: 'Presence', icon: 'presence', w: 600, h: 560, Component: Presence, css: 'prs',
    TitleChip: PresenceChip,
    blurb: 'narration, company, lucid dream — her modes of being there out loud, and the shelf she reads from' },
  { id: 'librarians', title: 'Librarians', icon: 'librarians', w: 620, h: 560, Component: Librarians, css: 'lib',
    TitleChip: AuxChip,
