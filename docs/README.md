...
| [`HOME-ASSISTANT.md`](HOME-ASSISTANT.md) | reference | **LIVE** | The house as a second door into the same telemetry lane: the HA bridge, the entity map (what crosses and what it becomes), the on-request hands and their allowlist, and the 🏠 beachhead panel. *(This cell was a copy-paste of TELEMETRY's for its whole life — 2026-08-29 audit.)* |
